...
/* radix:node */
class __TwigTemplate_968df395159d9cb8bd2a771681f5550c extends Template
{
  ...
  ";
    ...
    public function block_node_metadata(array $context, array $blocks = []): iterable
    {
        ...
        <div ";
          ...
          ";
            // line 90
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(t("Submitted by @author on @date", ["@author" => $this->sandbox->ensureToStringAllowed(            // line 91
($context["author_name"] ?? null), 91, $this->source), "@date" => $this->sandbox->ensureToStringAllowed(            // line 92
($context["date"] ?? null), 92, $this->source)]));
            // line 93
            yield "
        </div>
      </footer>
