...
";
            // line 10
            yield from             $this->loadTemplate("radix:page-navigation", "radix:page-navigation", 10, "235436915")->unwrap()->yield(CoreExtension::merge($context, ["container" => "fixed", "navbar_theme" => "light", "navbar_utility_classes" => ["justify-content-between"]]));
            // line 40
            yield "
";
            yield from [];
...
/* radix:page-navigation */
class __TwigTemplate_5272574c39b09c20bd3c85fca1eef27c___235436915 extends Template
{
    private Source $source;
    /**
     * @var array<string, Template>
