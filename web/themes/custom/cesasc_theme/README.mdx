...
cesasc_theme theme uses [Webpack](https://webpack.js.org) to compile and
bundle SASS and JS.
...
Go to the root of cesasc_theme theme and run the following commands:
`nvm use`
...
`drush en cesasc_theme -y`
`drush config-set system.theme default cesasc_theme -y`
